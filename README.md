...
На графииках представлено сравнение абсолютно всех обученных моделей. Слева снизу можно в названии обучения увидеть название модели "...dsnerf-constant", означающее, что это модель с DSNERF и постоянным коэффициентом включения. Сверху - метрика, справа снизу - значение метрики (value).
